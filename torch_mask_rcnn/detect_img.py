...
instance_segmentation_api('/home/xavier/vincent-dev/navigation_ws/src/torch_mask_rcnn/data/input_img/people.jpg', threshold=0.5, rect_th=6, text_th=1, text_size=1)
cv2.waitKey(0)
